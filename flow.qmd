...
```{r, echo = F}
readRDS("/Users/gretatimaite/Desktop/gcs_jps/figures/flow_comp.RDS")
```
...
```{r, echo = F}
readRDS("/Users/gretatimaite/Desktop/gcs_jps/figures/flow_div_comp.RDS")
```
...
```{r, echo = F}
readRDS("/Users/gretatimaite/Desktop/gcs_jps/figures/flow_sel_comp.RDS")
