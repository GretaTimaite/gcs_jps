...
```{r, echo = F}
readRDS("/Users/gretatimaite/Desktop/gcs_jps/figures/flow_comp.png")
```
...
```{r, echo = F}
readRDS("/Users/gretatimaite/Desktop/gcs_jps/figures/flow_div_comp.png")
```
...
```{r, echo = F}
readRDS("/Users/gretatimaite/Desktop/gcs_jps/figures/flow_sel_comp.png")
